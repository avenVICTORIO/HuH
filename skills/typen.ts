...
export type Post =
  | { art: "start"; text: string }            // die auslösende Chat-Nachricht
...
export type Flow = {
  ...
  name: string;
  beschreibung: string;
  /** Beispielsätze, mit denen man den Flow im Chat startet. */
  beispiele: string[];
  /** Erkennt eine Chat-Nachricht als Auslöser. */
  ausloeser: RegExp[];
...
export type LaufStatus = "laeuft" | "wartet" | "fertig" | "abgebrochen" | "fehler";
